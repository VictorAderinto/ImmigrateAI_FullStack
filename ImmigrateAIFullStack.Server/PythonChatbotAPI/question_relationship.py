...
def skipped_questions(field, answers):
    ...
    if field == 'has_fax_number' and field_value == 'no':
        return 6
    if field == 'primary_phone_extension' and field_value == 'no':
        return 1
    if field == 'alternate_phone_extension' and field_value == 'no':
        return 1
    if field == 'fax_extension' and field_value == 'no':
        return 1
    if field == 'parent1_phone_extension' and field_value == 'no':
        return 1
    if field == 'parent2_phone_extension' and field_value == 'no':
        return 1
    if field == 'custodian_phone_extension' and field_value == 'no':
        return 1
    ...
    if field == 'mailing_address_same' and field_value == 'yes':
        ...
        return 1
    if field == 'first_time_travel_outside_china' and field_value == 'yes':
        return 3
    return 0
